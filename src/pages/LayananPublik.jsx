  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`pt-24 pb-8 px-8 transition-opacity duration-1000 ease-out ${isMounted ? 'opacity-100' : 'opacity-0'}`}>
        <h1 className={`text-3xl font-bold text-center mb-12 text-gray-800 transition-transform transform ${isMounted ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'} duration-1000`}>Daftar Layanan Publik</h1>

        {layananList.map((category, index) => (
          <div key={index} className={`mb-12 transition-transform transform ${isMounted ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} duration-1000 delay-${index * 200}`}>
        ...
        <div className="flex justify-center items-center mt-12 transition-transform transform">
